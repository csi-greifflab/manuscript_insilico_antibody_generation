...
affinity_nsamples2 = function(){
    ...
    ggplot(data=meddf, mapping=aes(x=model_name, y=medval)) +
        ...
        labs(y='Affinity (Median Energy)', x='Dataset') +
        theme(axis.title = element_text(size=25),
                axis.text.x = element_text(angle=90, size=19),
...
# run stuff
# affinity_nsamples_transfer()
# plot_crosstransfer()
# plot_crosstransfer_ad()
# affinity_nsamples()
# affinity_nsamples_crosstransfer_ks() # panelB bottom
plot_affinity_nsamples_crosstransfer_ks() # panelB bottom
# affinity_nsamples_transfer_ks() # panelB top
# plot_affinity_nsamples_transfer_ks() #panelB top
# affinity_nsamples2() # panel A
