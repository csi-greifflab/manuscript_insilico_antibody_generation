...
def generate_seq(model, seed, iteration):
    ...
    for i in range(iterations):
        ...
        if i%10**4 == 0:
            outname = 'generator_corpus_eleven_ntrainingsamples_outfiles2/%s_corpus_geminio_%s.txt' % (model_tag, iteration)
...
training_dirs = [item for item in indirs if '2YPV' in item]
training_dirs = sorted([item for item in training_dirs if 'top_70000' in item])
wanteds = ['10000', '20000', '30000', '40000', '50000', '60000']
training_dirs = [item for item in training_dirs if item.split('_')[-4] in wanteds]
